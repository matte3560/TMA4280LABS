...
mv result.txt reduc_n16_s1.txt
mpirun -n 32 ../reduc/zeta 8388608
mv result.txt reduc_n32_s1.txt
...
mv result.txt reduc_rd_n16_s1.txt
mpirun -n 32 ../reduc/zeta_rd 8388608
mv result.txt reduc_rd_n32_s1.txt
...
mv result.txt reduc_n16_s2.txt
mpirun -n 32 ../reduc/zeta 16777216
mv result.txt reduc_n32_s2.txt
...
mv result.txt reduc_rd_n16_s2.txt
mpirun -n 32 ../reduc/zeta_rd 16777216
mv result.txt reduc_rd_n32_s2.txt
